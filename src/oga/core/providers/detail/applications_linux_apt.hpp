...
#ifndef GUARD_OGA_CORE_PROVIDERS_DETAIL_APPLICATIONS_LINUX_APT_HPP_INCLUDED
#define GUARD_OGA_CORE_PROVIDERS_DETAIL_APPLICATIONS_LINUX_APT_HPP_INCLUDED
...
class applications_linux_apt : public applications_linux {
public:
    applications_linux_apt(oga::log::logger_ptr logger);
